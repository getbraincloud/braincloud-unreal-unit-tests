...
namespace BrainCloud
{
	...
	void BrainCloudMessaging::markMessagesRead(const std::string& in_msgbox, const std::vector<std::string>& in_msgIds, bool markAsRead, IServerCallback* in_callback)
    {
		Json::Value message;
		message[OperationParam::MessagingMsgbox.getValue()] = in_msgbox;
		message[OperationParam::MessagingMsgIds.getValue()] = JsonUtil::stringVectorToJson(in_msgIds);
