...
namespace BrainCloud
{
	...
	void BrainCloudEntity::incrementUserEntityData(const char * in_entityId, const char * in_targetPlayerId, std::string in_jsonData, bool in_returnData, IServerCallback * in_callback)
	{
		Json::Value message;
		Json::Reader reader;
		...
		message[OperationParam::EntityServiceEntityId.getValue()] = in_entityId;
		message[OperationParam::EntityServiceTargetPlayerId.getValue()] = in_targetPlayerId;
		message[OperationParam::EntityServiceReturnData.getValue()] = in_returnData;
