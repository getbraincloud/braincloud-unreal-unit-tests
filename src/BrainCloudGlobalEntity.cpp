...
namespace BrainCloud
{
	...
	void BrainCloudGlobalEntity::incrementGlobalEntityData(const char * in_entityId, std::string in_jsonData, bool in_returnData, IServerCallback * in_callback)
	{
		Json::Value message;
		Json::Reader reader;

		message[OperationParam::GlobalEntityServiceEntityId.getValue()] = in_entityId;
		message[OperationParam::GlobalEntityServiceReturnData.getValue()] = in_returnData;
