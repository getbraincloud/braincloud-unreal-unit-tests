...
static void relayFullFlow(BrainCloudClient* bc, eRelayConnectionType connectionType)
{
	...
	{
		auto timeStart = steady_clock::now();
		while (steady_clock::now() < timeStart + seconds(30))
		{
			bc->runCallbacks();
			this_thread::sleep_for(milliseconds(100));
		}
...
//{
//	relayFullFlow(eRelayConnectionType::UDP);
//}
//
//TEST_F(TestBCRelayComms, FullFlowWS)
//{
//	relayFullFlow(eRelayConnectionType::WS);
//}
//
//TEST_F(TestBCRelayComms, FullFlowWSS)
//{
//	relayFullFlow(eRelayConnectionType::WSS);
//}
