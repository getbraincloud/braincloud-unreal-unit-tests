...
UBCGlobalEntityProxy* UBCGlobalEntityProxy::CreateEntity(const FString& entityType, const FString& timeToLive, UBrainCloudACL* jsonEntityAcl, const FString& jsonEntityData)
{
    UBCGlobalEntityProxy* Proxy = NewObject<UBCGlobalEntityProxy>();
    BrainCloudClient::getInstance()->getGlobalEntityService()->createEntity(entityType, timeToLive.IsEmpty() ? 0 :  FCString::Atoi64(*timeToLive), jsonEntityAcl, jsonEntityData, Proxy);
    return Proxy;
}

UBCGlobalEntityProxy* UBCGlobalEntityProxy::CreateEntityWithIndexedId(const FString& entityType, const FString& indexedId, const FString& timeToLive, UBrainCloudACL* jsonEntityAcl, const FString& jsonEntityData)
{
    UBCGlobalEntityProxy* Proxy = NewObject<UBCGlobalEntityProxy>();
    BrainCloudClient::getInstance()->getGlobalEntityService()->createEntityWithIndexedId(entityType, indexedId, timeToLive.IsEmpty() ? 0 : FCString::Atoi64(*timeToLive), jsonEntityAcl, jsonEntityData, Proxy);
    return Proxy;
}
...
UBCGlobalEntityProxy* UBCGlobalEntityProxy::UpdateEntityAcl(const FString& entityId, int32 version, UBrainCloudACL* jsonEntityAcl)
{
    UBCGlobalEntityProxy* Proxy = NewObject<UBCGlobalEntityProxy>();
    BrainCloudClient::getInstance()->getGlobalEntityService()->updateEntityAcl(entityId, version, jsonEntityAcl, Proxy);
    return Proxy;
}
