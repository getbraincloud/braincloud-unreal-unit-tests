...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Cloud Script")
		static UBCScriptProxy* RunScript(ABrainCloudActor *brainCloud, FString scriptName, FString jsonScriptData);
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Cloud Script")
		static UBCScriptProxy* ScheduleRunScriptUTC(ABrainCloudActor *brainCloud, FString scriptName, FString jsonScriptData, FDateTime startDateInUTC);
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Cloud Script")
		static UBCScriptProxy* ScheduleRunScriptMinutes(ABrainCloudActor *brainCloud, FString scriptName, FString jsonScriptData, int32 minutesFromNow);
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Cloud Script")
		static UBCScriptProxy* RunParentScript(ABrainCloudActor *brainCloud, FString scriptName, FString jsonScriptData, FString parentLevel);
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Cloud Script")
		static UBCScriptProxy* CancelScheduledScript(ABrainCloudActor *brainCloud, const FString& jobId);
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Cloud Script")
		static UBCScriptProxy* RunPeerScript(ABrainCloudActor *brainCloud, const FString& scriptName, const FString& jsonScriptData, const FString& peer);
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Cloud Script")
		static UBCScriptProxy* RunPeerScriptAsync(ABrainCloudActor *brainCloud, const FString& scriptName, const FString& jsonScriptData, const FString& peer);
