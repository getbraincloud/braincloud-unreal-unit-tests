...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Player State")
		static UBCPlayerStateProxy* ReadPlayerState(ABrainCloudActor *brainCloud);
    ...
    */
    UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Player State")
        static UBCPlayerStateProxy* ReadUserState(ABrainCloudActor *brainCloud);

	/**
	* @deprecated Use DeleteUser instead
	*/
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Player State")
		static UBCPlayerStateProxy* DeletePlayer(ABrainCloudActor *brainCloud);
    ...
    */
    UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Player State")
        static UBCPlayerStateProxy* DeleteUser(ABrainCloudActor *brainCloud);

	/**
	* @deprecated Use ResetUserState instead
	*/
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Player State")
		static UBCPlayerStateProxy* ResetPlayerState(ABrainCloudActor *brainCloud);
    ...
    */
    UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Player State")
        static UBCPlayerStateProxy* ResetUserState(ABrainCloudActor *brainCloud);
    ...
    */
    UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Player State")
        static UBCPlayerStateProxy* Logout(ABrainCloudActor *brainCloud);

	/**
	* @deprecated Use UpdateName instead
	*/
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Player State")
		static UBCPlayerStateProxy* UpdatePlayerName(ABrainCloudActor *brainCloud, FString playerName);
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Player State")
        static UBCPlayerStateProxy* UpdateUserName(ABrainCloudActor *brainCloud, FString userName);
    ...
    */
    UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Player State")
        static UBCPlayerStateProxy* UpdateName(ABrainCloudActor *brainCloud, FString name);
    ...
    */
    UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Player State")
        static UBCPlayerStateProxy* UpdateSummaryFriendData(ABrainCloudActor *brainCloud, const FString& jsonSummaryData);
    ...
    */
    UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Player State")
        static UBCPlayerStateProxy* GetAttributes(ABrainCloudActor *brainCloud);
    ...
    */
    UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Player State")
        static UBCPlayerStateProxy* UpdateAttributes(ABrainCloudActor *brainCloud, FString jsonAttributes, bool wipeExisting);
    ...
    */
    UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Player State")
        static UBCPlayerStateProxy* RemoveAttributes(ABrainCloudActor *brainCloud, const TArray<FString>& attributeNames);

	/**
	* @deprecated Use UpdateUserPictureUrl instead
	*/
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Player State")
		static UBCPlayerStateProxy* UpdatePlayerPictureUrl(ABrainCloudActor *brainCloud, const FString& pictureUrl);
    ...
    */
    UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Player State")
        static UBCPlayerStateProxy* UpdateUserPictureUrl(ABrainCloudActor *brainCloud, const FString& pictureUrl);
    ...
    */
    UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Player State")
        static UBCPlayerStateProxy* UpdateContactEmail(ABrainCloudActor *brainCloud, const FString& contactEmail);
