...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Tournament")
		static UBCTournamentProxy* ClaimTournamentReward(ABrainCloudActor *brainCloud, const FString& leaderboardId, int32 versionId);
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Tournament")
		static UBCTournamentProxy* GetTournamentStatus(ABrainCloudActor *brainCloud, const FString& leaderboardId, int32 versionId);
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Tournament")
		static UBCTournamentProxy* JoinTournament(ABrainCloudActor *brainCloud, const FString& leaderboardId, const FString& tournamentCode, int32 initialScore);
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Tournament")
		static UBCTournamentProxy* LeaveTournament(ABrainCloudActor *brainCloud, const FString& leaderboardId);
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Tournament")
		static UBCTournamentProxy* PostTournamentScore(ABrainCloudActor *brainCloud, const FString& leaderboardId, int32 score, const FString& jsonData, const struct FDateTime roundStartedTime);
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Tournament")
		static UBCTournamentProxy* ViewCurrentReward(ABrainCloudActor *brainCloud, const FString& leaderboardId);
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Tournament")
		static UBCTournamentProxy* ViewReward(ABrainCloudActor *brainCloud, const FString& leaderboardId, int32 versionId);
