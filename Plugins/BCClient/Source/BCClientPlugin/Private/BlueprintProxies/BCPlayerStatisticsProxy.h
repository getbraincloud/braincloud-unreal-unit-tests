...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Player Statistics")
		static UBCPlayerStatisticsProxy* ReadAllPlayerStats(ABrainCloudActor *brainCloud);
    ...
    */
    UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Player Statistics")
        static UBCPlayerStatisticsProxy* ReadAllUserStats(ABrainCloudActor *brainCloud);

	/**
	* @deprecated Use ReadUserStatsSubset instead - removal after September 1 2017
	*/
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Player Statistics")
		static UBCPlayerStatisticsProxy* ReadPlayerStatsSubset(ABrainCloudActor *brainCloud, const TArray<FString>& playerStats);
    ...
    */
    UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Player Statistics")
        static UBCPlayerStatisticsProxy* ReadUserStatsSubset(ABrainCloudActor *brainCloud, const TArray<FString>& userStats);

	/**
	* @deprecated Use ReadUserStatisticsByCategory instead - removal after September 1 2017
	*/
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Player Statistics")
		static UBCPlayerStatisticsProxy* ReadPlayerStatisticsByCategory(ABrainCloudActor *brainCloud, FString category);
    ...
    */
    UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Player Statistics")
        static UBCPlayerStatisticsProxy* ReadUserStatisticsByCategory(ABrainCloudActor *brainCloud, FString category);

	/**
	* @deprecated Use ResetAllUserStats instead - removal after September 1 2017
	*/
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Player Statistics")
		static UBCPlayerStatisticsProxy* ResetAllPlayerStats(ABrainCloudActor *brainCloud);
    ...
    */
    UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Player Statistics")
        static UBCPlayerStatisticsProxy* ResetAllUserStats(ABrainCloudActor *brainCloud);

	/**
	* @deprecated Use IncrementUserStats instead - removal after September 1 2017
	*/
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Player Statistics")
		static UBCPlayerStatisticsProxy* IncrementPlayerStats(ABrainCloudActor *brainCloud, FString jsonData);
    ...
    */
    UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Player Statistics")
        static UBCPlayerStatisticsProxy* IncrementUserStats(ABrainCloudActor *brainCloud, FString jsonData);
    ...
    */
    UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Player Statistics")
        static UBCPlayerStatisticsProxy* GetNextExperienceLevel(ABrainCloudActor *brainCloud);
    ...
    */
    UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Player Statistics")
        static UBCPlayerStatisticsProxy* IncrementExperiencePoints(ABrainCloudActor *brainCloud, int32 xpValue);
    ...
    */
    UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Player Statistics")
        static UBCPlayerStatisticsProxy* SetExperiencePoints(ABrainCloudActor *brainCloud, int32 xpValue);
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Player Statistics")
		static UBCPlayerStatisticsProxy* ProcessStatistics(ABrainCloudActor *brainCloud, FString jsonData);
