...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Global Entity")
		static UBCGlobalEntityProxy* CreateEntity(const FString& entityType, const FString& timeToLive, UBrainCloudACL* entityAcl, const FString& jsonEntityData);
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Global Entity")
		static UBCGlobalEntityProxy* CreateEntityWithIndexedId(const FString& entityType, const FString& indexedId, const FString& timeToLive, UBrainCloudACL* entityAcl, const FString& jsonEntityData);
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Global Entity")
		static UBCGlobalEntityProxy* UpdateEntityAcl(const FString& entityId, int32 version, UBrainCloudACL* entityAcl);
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Global Entity")
		static UBCGlobalEntityProxy* UpdateEntityOwnerAndAcl(const FString& entityId, int32 version, const FString& ownerId, UBrainCloudACL* entityAcl);
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Global Entity")
		static UBCGlobalEntityProxy* MakeSystemEntity(const FString& entityId, int32 version, UBrainCloudACL* entityAcl);
