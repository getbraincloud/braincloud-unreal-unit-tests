...
public:
	...
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Group")
		static UBCGroupProxy* AcceptGroupInvitation(const FString& groupId);
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Group")
		static UBCGroupProxy* AddGroupMember(const FString& groupId, const FString& profileId, ERole role, const FString& jsonAttributes);
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Group")
		static UBCGroupProxy* ApproveGroupJoinRequest(const FString& groupId, const FString& profileId, ERole role, const FString& jsonAttributes);
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Group")
		static UBCGroupProxy* AutoJoinGroup(const FString& groupType, EAutoJoinStrategy autoJoinStrategy, const FString& dataQueryJson);
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Group")
		static UBCGroupProxy* CancelGroupInvitation(const FString& groupId, const FString& profileId);
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Group")
		static UBCGroupProxy* DeleteGroup(const FString& groupId, int32 version);
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Group")
		static UBCGroupProxy* DeleteGroupEntity(const FString& groupId, const FString& entityId, int32 version);
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Group")
		static UBCGroupProxy* GetMyGroups();
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Group")
		static UBCGroupProxy* IncrementGroupData(const FString& groupId, const FString& jsonData);
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Group")
		static UBCGroupProxy* IncrementGroupEntityData(const FString& groupId, const FString& entityId, const FString& jsonData);
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Group")
		static UBCGroupProxy* InviteGroupMember(const FString& groupId, const FString& profileId, ERole role, const FString& jsonAttributes);
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Group")
		static UBCGroupProxy* JoinGroup(const FString& groupId);
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Group")
		static UBCGroupProxy* LeaveGroup(const FString& groupId);
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Group")
		static UBCGroupProxy* ListGroupsPage(const FString& jsonContext);
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Group")
		static UBCGroupProxy* ListGroupsPageByOffset(const FString& context, int32 pageOffset);
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Group")
		static UBCGroupProxy* ListGroupsWithMember(const FString& profileId);
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Group")
		static UBCGroupProxy* ReadGroup(const FString& groupId);
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Group")
		static UBCGroupProxy* ReadGroupData(const FString& groupId);
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Group")
		static UBCGroupProxy* ReadGroupEntitiesPage(const FString& jsonContext);
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Group")
		static UBCGroupProxy* ReadGroupEntitiesPageByOffset(const FString& context, int32 pageOffset);
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Group")
		static UBCGroupProxy* ReadGroupEntity(const FString& groupId, const FString& entityId);
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Group")
		static UBCGroupProxy* ReadGroupMembers(const FString& groupId);
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Group")
		static UBCGroupProxy* RejectGroupInvitation(const FString& groupId);
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Group")
		static UBCGroupProxy* RejectGroupJoinRequest(const FString& groupId, const FString& profileId);
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Group")
		static UBCGroupProxy* RemoveGroupMember(const FString& groupId, const FString& profileId);
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Group")
		static UBCGroupProxy* UpdateGroupData(const FString& groupId, int32 version, const FString& jsonData);
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Group")
		static UBCGroupProxy* UpdateGroupEntityData(const FString& groupId, const FString& entityId, int32 version, const FString& jsonData);
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Group")
		static UBCGroupProxy* UpdateGroupMember(const FString& groupId, const FString& profileId, ERole role, const FString& jsonAttributes);
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "BrainCloud|Group")
		static UBCGroupProxy* UpdateGroupName(const FString& groupId, const FString& name);
