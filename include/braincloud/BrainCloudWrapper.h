...
namespace BrainCloud {
    ...
    public:
         ...
         * You are free to pick anything you want.
         */
        void initialize(const char * in_serverUrl, const char * in_secretKey, const char * in_gameId, const char * in_gameVersion, const char * in_companyName, const char * in_gameName);
